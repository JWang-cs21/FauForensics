...
parser.add_argument('--PATH_save',     type=str,   default='0807',  help='Folder name for backup.')
parser.add_argument('--train_file',      type=str,   default='train', help='Folder name for backup.')
parser.add_argument('--labels_folder',   type=str,   default='labels_end', help='Folder name for labels.')
parser.add_argument('--test_file',       type=str,   default='default', help='Folder name for backup.')
parser.add_argument('--val_file',        type=str,   default='default', help='Folder name for backup.')
...
parser.add_argument('--LR',              type=float, default=0.001,   help='lr_decay_rate (default: 5e-4)')
parser.add_argument('--LR_policy',       type=str,   default='poly',  choices=['poly', 'stair', 'warmup_linear', 'warmup_cosine', 'warmup_poly'], help='')
parser.add_argument('--m_LR_decay',      type=float, default=0.001,   help='lr_decay_rate (default: 5e-4)')
parser.add_argument('--LR_decay',        type=float, default=0.01,   help='lr_decay_rate (default: 5e-4)')
...
parser.add_argument('--is_test',         type=int,   default=0,       help='Label for determining whether to test.')
parser.add_argument('--is_adjustLR',     type=int,   default=0,       help='Label for determining whether to adjust learning rate.')
parser.add_argument('--is_multi_lr',     type=int,   default=0,       help='Label for determining whether to adjust learning rate.')
